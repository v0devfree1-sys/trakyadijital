...
export default function OAuthConsent() {
  ...
  if (reconnect) {
    return (
      <AuthLayout icon={ShieldCheck} title="Reconnect required">
        <div className="p-3 bg-destructive/10 text-destructive text-sm border-l-2 border-l-destructive">
          {reconnect}
        </div>
      </AuthLayout>
    );
  ...
  return (
    ...
    >
      {error && (
        <div className="mb-4 p-3 bg-destructive/10 text-destructive text-sm border-l-2 border-l-destructive">
          {error}
        </div>
      )}
